...
Module 11 HTML web-scraping Challenge--Elizabeth Perez Silva
...
# Code Source
- Starter code from Module 11 Challenge file
- Example solutions from class lectures
- Class lecture recordings on Zoom
- Further reading link on Canvas: Web Scraping with Python Using Beautiful Soup
